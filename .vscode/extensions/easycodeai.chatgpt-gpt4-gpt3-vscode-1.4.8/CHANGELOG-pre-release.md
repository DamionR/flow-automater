...
- Added an apply change feature which will apply the change into the file
  - This is only available to chats started with ask codebase and the '@' system
- Improved error reporting analytics
- Bug fixes for autocomplete context tracking
...
- Improved indexing performance for these file extensions:
